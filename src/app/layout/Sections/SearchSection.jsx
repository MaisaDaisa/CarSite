...
const SearchSection = () => {
	...
	return (
		<div className="flex flex-row w-svw justify-start p-2  min-h-screen ">
			<div className="flex p-4 gap-8 flex-col w-[300px] justify-start rounded-lg bg-secondary-gray ">
